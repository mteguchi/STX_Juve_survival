...
In the model, p is the proportion of neophytes in year y that hatched x years ago, where x is 9, 10, 11, or 12. These proportions don't add up to 1.0 because the number of neophytes at year y is a combination of hatchlings that survived 9-12 years (H(y-9) ... H(y-12)). The proportion (p(y,x)) is the proportion of N(y) that came from x years ago. 
